...
interface PideConfigDialogProps {
  open: boolean;
...
export function PideConfigDialog({ open, onOpenChange, pideName, onComplete }: PideConfigDialogProps) {
  ...
  const handleComplete = () => {
    ...
    const formattedExtras = selectedExtras.map(extraName => {
      const extra = PIDE_EXTRAS.find(e => e.name === extraName);
