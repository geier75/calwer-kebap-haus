      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="space-y-6 text-sm text-[rgb(var(--text-secondary))]">
          <section>
            ...
            <p className="font-semibold text-white">Calwer Pizza & Kebaphaus</p>
            <p>Inselgasse 3</p>
            <p>75365 Calw</p>
            <p>Deutschland</p>
          </section>
